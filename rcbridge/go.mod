...
// Use the Telegram Drive backend from the maintained fork.
replace github.com/rclone/rclone => github.com/PhateValleyman/rclone v0.0.0-20260827215738-c16db93bc91a
